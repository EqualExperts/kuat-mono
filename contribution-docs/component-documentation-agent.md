...
- Register IDs in `kuat-docs/components/components.manifest.json` (align with upstream [component-registry](https://github.com/equalexperts/kuat-agent-docs/blob/main/reference/media-types/web-product/component-registry.md))
