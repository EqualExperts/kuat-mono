...
export const WithIcons: Story = {
  render: () => ({
    components: { Button, ButtonGroup, DownloadIcon, ShareIcon, ArchiveIcon, TrashIcon },
    template: `
      <ButtonGroup>
...
export const AllVariants: Story = {
  render: () => ({
    components: { Button, ButtonGroup, ButtonGroupSeparator, ButtonGroupText },
    template: `
      <div class="flex flex-col gap-8">
        ...
        <div>
          <h3 class="text-sm font-medium mb-2">With Separator</h3>
          <ButtonGroup>
            <Button variant="outline">Save</Button>
            <Button variant="outline">Cancel</Button>
            <ButtonGroupSeparator />
...
export const DarkMode: Story = {
  render: () => ({
    components: { Button, ButtonGroup, ButtonGroupText },
    template: `
      <div class="dark flex flex-col gap-4 p-4 bg-slate-950">
        <ButtonGroup>
          <Button variant="outline">Archive</Button>
          <Button variant="outline">Report</Button>
          <Button variant="outline">Delete</Button>
