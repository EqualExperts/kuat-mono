...
**Consumers:** [Choosing components (Kuat vs shadcn)](../../setup/choosing-components.md) · [Public API inventory](../../setup/public-api-inventory.md).

**Per-component usage guides (published):** [kuat-docs/components/](../../components/) — `button.md`, `button-group.md`, etc., bundled into `agent-docs/components/` on release. Storybook remains the API reference; markdown guides cover when/how to use.
