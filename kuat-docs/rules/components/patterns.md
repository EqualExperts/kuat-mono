...
See `AGENTS.md` in the repo root for the canonical local implementation rules. `.cursorrules` and `CLAUDE.md` are generated/bootstrap entry points that point to `AGENTS.md`.
